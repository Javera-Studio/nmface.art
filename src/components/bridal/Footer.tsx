...
export function Footer() {
  return (
    <footer style={{ backgroundColor: "rgba(200, 177, 182, 1)" }}>
      <div className="mx-auto max-w-6xl px-6 sm:px-10 py-14 grid md:grid-cols-3 gap-12 md:gap-20">
      ...
      <div className="border-t border-white/20">
        <div className="mx-auto max-w-6xl px-6 sm:px-10 py-5 text-[13px] text-white/50 flex flex-col sm:flex-row gap-2 justify-between items-center">
          ...
          <p>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-white/70 tracking-[0.18em] uppercase hover:text-white transition-colors duration-300"
            >
              JAVERA STUDIO
            </a>
          </p>
